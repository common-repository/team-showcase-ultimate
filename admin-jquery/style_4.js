...
jQuery("#team-top-border-radius").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo img{ border-radius:" + jQuery('#team-top-border-radius').val() + "px " + jQuery('#team-top-border-radius').val() + "px " + jQuery('#team-bottom-border-radius').val() + "px " + jQuery('#team-bottom-border-radius').val() + "px;} </style>").appendTo("#oxilab-preview-data");
});
