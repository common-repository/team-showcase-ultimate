...
jQuery("#team-box-bg-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{background-color: " + jQuery('#team-box-bg-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-box-margin").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{top: " + jQuery("#team-box-margin").val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{right: " + jQuery("#team-box-margin").val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{bottom: " + jQuery("#team-box-margin").val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{left: " + jQuery("#team-box-margin").val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-icon-padding-left-right").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{padding-right: " + jQuery("#team-icon-padding-left-right").val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{padding-left: " + jQuery("#team-icon-padding-left-right").val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#des-margin-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{ padding-bottom: " + jQuery("#des-margin-bottom").val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
