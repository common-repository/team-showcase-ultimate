...
jQuery("#team-icon-padding-left-right").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo{ padding:" + jQuery('#team-icon-padding-left-right').val() + "px " + jQuery('#team-icon-padding-left-right').val() + "px;} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#team-box-bg-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-icons{background-color: " + jQuery('#team-box-bg-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#name-general-padding-top-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-info{ bottom:" + jQuery('#name-general-padding-top-bottom').val() + "px;} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-box-border-left-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo:before{border-left-color: " + jQuery('#team-box-border-left-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo:before{border-top-color: " + jQuery('#team-box-border-left-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-box-border-right-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo:before{border-right-color: " + jQuery('#team-box-border-right-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo:before{border-bottom-color: " + jQuery('#team-box-border-right-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#name-background-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-name{background-color: " + jQuery('#name-background-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#name-margin-top").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-name{ padding:" + jQuery('#name-margin-top').val() + "px " + jQuery('#name-margin-bottom').val() + "px;} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#position-background-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-role{background-color: " + jQuery('#position-background-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#position-margin-top").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-role{ padding:" + jQuery('#position-margin-top').val() + "px " + jQuery('#position-margin-bottom').val() + "px;} </style>").appendTo("#oxilab-preview-data");
});
