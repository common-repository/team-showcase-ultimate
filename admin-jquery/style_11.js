...
jQuery("#team-box-bg-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size:before{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + ":hover .member-photo{border-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
...
jQuery("#name-general-padding-top-bottom").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-content{ padding-bottom:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#icon-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-member-icons-border .member-icon i{ border-right-color:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-member-icons-border .member-icon i{ border-bottom-color:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-member-icons-background-border .member-icon i{ border-color:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
...
jQuery("#icon-padding-top-bottom").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-icons{ padding-top:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-icons{ padding-bottom:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#icon-padding-left-right").on("change", function () {
    var idvalue = jQuery('#icon-padding-left-right').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-icons{ padding-right:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-icons{ padding-left:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#icon-radius").on("change", function () {
    var idvalue = jQuery('#icon-radius').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-icon i{ border-radius:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#team-border-color").on("change", function () {
    var idvalue = jQuery('#team-border-color').val();
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo{border-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show:after{background: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show:before{background: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#Scroll-width").on("change", function () {
    var idvalue = jQuery('#Scroll-width').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show:before{ width:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show:after{ width:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{ padding-right:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{ padding-left:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-border").on("change", function () {
    var idvalue = jQuery('#team-border').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo{ border-width:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-border-type").on("change", function () {
    var idvalue = jQuery('#team-border-type').val();
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo{  border-style:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});