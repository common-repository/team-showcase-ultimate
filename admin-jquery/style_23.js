...
jQuery("#image-margin-top").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + "{padding-top: " + jQuery('#image-margin-top').val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + "{padding-bottom: " + jQuery('#image-margin-top').val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#image-margin-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + "{padding-left: " + jQuery('#image-margin-bottom').val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + "{padding-right: " + jQuery('#image-margin-bottom').val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#team-box-bg-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + ":hover .member-info-body{background-color: " + jQuery('#team-box-bg-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-icon-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{padding-top: " + jQuery("#team-icon-padding-top").val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-icon-padding-left-right").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{padding-left: " + jQuery("#team-icon-padding-left-right").val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{padding-right: " + jQuery("#team-icon-padding-left-right").val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#position-border-bottom-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-info:before{background-color: " + jQuery('#position-border-bottom-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#des-font-size").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{ font-size:" + jQuery('#des-font-size').val() + "px;} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#des-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{color:" + jQuery('#des-color').val() + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery('#des-font-family').change(function () {
    var font = jQuery(this).val().replace(/\+/g, ' ');
    font = font.split(':');
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{ font-family:" + font[0] + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#des-font-weight").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{font-weight:" + jQuery('#des-font-weight').val() + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#des-font-style").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{font-style:" + jQuery('#des-font-style').val() + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#des-margin-bottom").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-p{ margin-top: " + jQuery("#des-margin-bottom").val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#icon-div-background-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo-span:before{background-color: " + jQuery('#icon-div-background-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo-span:after{background-color: " + jQuery('#icon-div-background-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
