...
jQuery("#team-box-content-hover-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-info:after{background-color: " + jQuery('#team-box-content-hover-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
