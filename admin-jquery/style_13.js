...
jQuery("#team-box-shadow-color").on("change", function () {
    ...
    jQuery("<style type='text/css'>.oxi-team-show-" + styleid + " .member-photo{ box-shadow:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#name-font-style").on("change", function () {
    var idvalue = jQuery('#name-font-style').val();
...
jQuery("#icon-div-background-color").on("change", function () {
    var idvalue = jQuery('#icon-div-background-color').val();
...
jQuery("#team-border-width-color").on("change", function () {
    var idvalue = jQuery('#team-border-width-color').val();
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show:after{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show:before{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo{border-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-box-bg-color-padding-left").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{padding: " + jQuery('#team-box-bg-color-padding-top').val() + "px " + jQuery('#team-box-bg-color-padding-left').val() + "px; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'>  .oxi-team-show-" + styleid + " .oxi-team-show:before{width: calc(" + jQuery('#team-box-bg-color-padding-left').val() + "px - 3px); } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'>  .oxi-team-show-" + styleid + " .oxi-team-show:after{width: calc(" + jQuery('#team-box-bg-color-padding-left').val() + "px - 3px); } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-box-bg-color-padding-top").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{padding: " + jQuery('#team-box-bg-color-padding-top').val() + "px " + jQuery('#team-box-bg-color-padding-left').val() + "px; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-box-bg-color-border").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo{border: " + jQuery(this).val() + "px solid " + jQuery('#team-border-width-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});