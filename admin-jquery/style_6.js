...
jQuery("#team-padding-top-bottom").on("change", function () {
    var idvalue = jQuery('#team-padding-top-bottom').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{ padding-top:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{ padding-bottom:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#team-padding-left-right").on("change", function () {
    var idvalue = jQuery('#team-padding-left-right').val() + 'px';
...
jQuery("#name-general-padding-top-bottom").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-info{ padding-top:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-info{ padding-bottom:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#name-general-padding-left-right").on("change", function () {
    var idvalue = jQuery('#name-general-padding-left-right').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-info{ padding-right:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-info{ padding-left:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#icon-distance").on("change", function () {
    ...
    jQuery("<style type='text/css'>  .oxi-team-show-" + styleid + " .member-icon i{margin-top: 0; margin-bottom: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'>  .oxi-team-show-" + styleid + " .oxi-team-right .member-icon i{margin-bottom: 0; margin-top: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'>  .oxi-team-show-" + styleid + " .oxi-team-center .member-icon i{margin-bottom: " + idvalue02 + "; margin-top: " + idvalue02 + "; } </style>").appendTo("#oxilab-preview-data");
...
jQuery("#team-top-border-radius").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-photo .oxi-team-pic-size img{ border-radius:" + jQuery('#team-top-border-radius').val() + "px " + jQuery('#team-top-border-radius').val() + "px " + 0 + "px " + 0 + "px;} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#team-border-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{border-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
});
