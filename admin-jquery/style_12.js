...
jQuery("#team-box-bg-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-content{background: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
...
jQuery("#Scroll-padding").on("change", function () {
    var idvalue = jQuery('#Scroll-padding').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-show{ padding-top:" + 0 + ";} </style>").appendTo("#oxilab-preview-data");
