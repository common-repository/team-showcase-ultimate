...
jQuery("#icon-div-background-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .member-icons:before{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-center .member-icons:after{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
});
