...
jQuery("#team-box-bg-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + ":hover .oxi-team-pic-size-span{background-color: " + jQuery('#team-box-bg-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
jQuery("#content-background-color").on("change", function () {
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-team-pic-size .member-info-body{background-color: " + jQuery('#content-background-color').val() + "; } </style>").appendTo("#oxilab-preview-data");
});
