...
jQuery("#team-box-bg-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-content:before{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-content:after{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
});
