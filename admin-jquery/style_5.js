...
jQuery("#team-box-bg-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-show-info{background-color: " + idvalue + "; } </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#name-general-padding-top-bottom").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-show-info{ padding-top:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-show-info{ padding-bottom:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
jQuery("#name-general-padding-left-right").on("change", function () {
    var idvalue = jQuery('#name-general-padding-left-right').val() + 'px';
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-show-info{ padding-right:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .team-show-info{ padding-left:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
});
...
jQuery("#icon-background-color").on("change", function () {
    ...
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + "   .member-icons i{ background-color:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
    jQuery("<style type='text/css'> .oxi-team-show-" + styleid + " .oxi-member-icons-background-border .member-icons i{ background-color:" + idvalue + ";} </style>").appendTo("#oxilab-preview-data");
