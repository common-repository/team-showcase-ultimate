...
function oxi_team_show_style_21_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_21($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                    ...
                                    <div class="oxi-team-pic-size">
                                        ...
                                        <div class="member-info-body">
                                            ...
                                            <div class="member-icons ' . $styledata[157] . '">
                                                    ' . oxi_team_show_style_21_social($data[9], $data[7], $styledata[79]) . '
                                                    ' . oxi_team_show_style_21_social($data[13], $data[11], $styledata[79]) . '
                                                    ' . oxi_team_show_style_21_social($data[17], $data[15], $styledata[79]) . '
                                                    ' . oxi_team_show_style_21_social($data[21], $data[19], $styledata[79]) . '
                                            </div>
                                        </div>
                                    </div>                                                
        ...
        <style>
            ...
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-pic-size .member-info-body{
                position: absolute;
                left: <?php echo $styledata[181]; ?>px; 
                top: <?php echo $styledata[181]; ?>px; 
                right: <?php echo $styledata[181]; ?>px; 
                bottom: <?php echo $styledata[181]; ?>px;                                     
                opacity: 0;
