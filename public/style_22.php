...
function oxi_team_show_style_22_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_22($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                        ...
                                        <div class="oxi-team-pic-size">
                                            ...
                                            <div class="member-info-body"> 
                                                <div class="member-icons ' . $styledata[157] . '">
                                                    ' . oxi_team_show_style_22_social($data[9], $data[7], $styledata[79]) . '
                                                    ' . oxi_team_show_style_22_social($data[13], $data[11], $styledata[79]) . '
                                                    ' . oxi_team_show_style_22_social($data[17], $data[15], $styledata[79]) . '
                                                    ' . oxi_team_show_style_22_social($data[21], $data[19], $styledata[79]) . '
                                                </div>
        ...
        <style>
            ...
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-pic-size-span{
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
            ...
            .oxi-team-show-<?php echo $styleid; ?>:hover .oxi-team-pic-size-span{
                height: 100%;
            ...
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-pic-size .member-info-body{
                ...
                left: 0; 
                right: 0; 
                bottom: <?php echo $styledata[139]; ?>px;   
            ...
            .oxi-team-show-<?php echo $styleid; ?> .member-icons{                                   
                position: absolute;
                top: -<?php echo $styledata[139] / 2; ?>px; 
                width: 100%;
                padding-top:0;
                padding-bottom:0;
            ...
            .oxi-team-show-<?php echo $styleid; ?> .member-info{
                width: 100%;
                float: left;
                margin-top: <?php echo $styledata[139] / 2; ?>px;
            }
            ...
            .oxi-team-show-<?php echo $styleid; ?>:hover .member-icons [class^='fa']{
