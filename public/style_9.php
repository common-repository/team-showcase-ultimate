...
function oxi_team_show_style_9_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_9($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
                                    ...
                                    <div class="oxi-team-show ' . $styledata[77] . '">
                                        <div class="member-photo">
                                            ...
                                            <div class="member-icons ' . $styledata[157] . '">
                                                ' . oxi_team_show_style_9_social($data[9], $data[7], $styledata[79]) . '
                                                ' . oxi_team_show_style_9_social($data[13], $data[11], $styledata[79]) . '
                                                ' . oxi_team_show_style_9_social($data[17], $data[15], $styledata[79]) . '
                                                ' . oxi_team_show_style_9_social($data[21], $data[19], $styledata[79]) . '
                                            </div>
                                        </div>
