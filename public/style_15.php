...
function oxi_team_show_style_15_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_15($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                ...
                                <div class="member-photo">
                                    ...
                                    <div class="team-content">                                                   
                                        ...
                                        <div class="member-icons ' . $styledata[157] . '">
                                            ' . oxi_team_show_style_15_social($data[9], $data[7], $styledata[79]) . '
                                            ' . oxi_team_show_style_15_social($data[13], $data[11], $styledata[79]) . '
                                            ' . oxi_team_show_style_15_social($data[17], $data[15], $styledata[79]) . '
                                            ' . oxi_team_show_style_15_social($data[21], $data[19], $styledata[79]) . '
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <style>
            ...
            .oxi-team-show-<?php echo $styleid; ?> .member-name:before{
                content: "";
                width: <?php echo $styledata[161]; ?>px;
                height: 110px;
            ...
            .oxi-team-show-<?php echo $styleid; ?> .member-name:after{
                content: "";
                width: <?php echo $styledata[161]; ?>px;
                height: 110px;
                background: <?php echo $styledata[159]; ?>;
