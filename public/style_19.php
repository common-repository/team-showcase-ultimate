...
function oxi_team_show_style_19_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_19($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                ...
                                <div class="oxi-team-show ' . $styledata[77] . '">
                                    <div class="member-photo">
                                        <div class="oxi-team-pic-size">
                                            ...
                                            <div class="member-p"><div class="member-p-data"> ' . oxilab_team_html_special_charecter($data[25]) . '</div></div>      
                                        </div>
                                        <div class="member-icons ' . $styledata[157] . '">
                                            ' . oxi_team_show_style_19_social($data[9], $data[7], $styledata[79]) . '
                                            ' . oxi_team_show_style_19_social($data[13], $data[11], $styledata[79]) . '
                                            ' . oxi_team_show_style_19_social($data[17], $data[15], $styledata[79]) . '
                                            ' . oxi_team_show_style_19_social($data[21], $data[19], $styledata[79]) . '
                                        </div>
        ...
        <style>
            ...
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-pic-size .member-p .member-p-data{
                position: absolute;
                left: 0; 
                bottom: <?php echo $styledata[179]; ?>px;
                width: 100%;
                display: block;
            ...
            .oxi-team-show-<?php echo $styleid; ?>:hover .oxi-team-pic-size .member-p{
                opacity: 1;
            }
            ...
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-center .oxi-team-pic-size .member-p .member-p-data {
                text-align: center;
            }
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-center .member-icons{
                text-align: center;
            }
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-right .oxi-team-pic-size .member-p .member-p-data{
                text-align: right;
            }           
