...
function oxi_team_show_style_4_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_4($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                ...
                                <div class="oxi-team-show ' . $styledata[77] . ' ">
                                    <div class="member-photo">
                                        ...
                                        <div class="oxi-team-absolute">
                                           ...
                                           ' . oxi_team_show_style_4_social($data[9], $data[7], $styledata[79]) . '
                                            ' . oxi_team_show_style_4_social($data[13], $data[11], $styledata[79]) . '
                                            ' . oxi_team_show_style_4_social($data[17], $data[15], $styledata[79]) . '
                                            ' . oxi_team_show_style_4_social($data[21], $data[19], $styledata[79]) . '
                                            </div>
        ...
        <style>
            ...
            .oxi-team-show-<?php echo $styleid; ?> .member-photo img {
                -webkit-border-radius:  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px;
                -moz-border-radius:  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px;
                -ms-border-radius:  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px;
                -o-border-radius:  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px;
                border-radius:  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px  <?php echo $styledata[153]; ?>px;
            }
            .oxi-team-show-<?php echo $styleid; ?> .member-photo{
                position: relative;
            ...
            .oxi-team-show-<?php echo $styleid; ?> .member-photo:hover {
