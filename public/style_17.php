...
function oxi_team_show_style_17_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_17($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                ...
                                <div class="member-photo">
                                    <div class="oxi-team-pic-size">
                                        ...
                                        <div class="member-info ">
                                            <span><h3 class="member-name">' . oxilab_team_html_special_charecter($data[1]) . '</h3></span>
                                            <span>
                                    ...
                                    <div class="member-icons ' . $styledata[157] . '">
                                        ' . oxi_team_show_style_17_social($data[9], $data[7], $styledata[79]) . '
                                        ' . oxi_team_show_style_17_social($data[13], $data[11], $styledata[79]) . '
                                        ' . oxi_team_show_style_17_social($data[17], $data[15], $styledata[79]) . '
                                        ' . oxi_team_show_style_17_social($data[21], $data[19], $styledata[79]) . '
                                    </div>
                                </div>
                            </div>
                        </div>';
        ...
        <style>
            ...
            .oxi-team-show-<?php echo $styleid; ?> .member-info span{
                width: 100%;
                float: left;
            }
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-right .member-info span{
                text-align: right;
            }
