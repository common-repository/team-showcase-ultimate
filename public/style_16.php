...
function oxi_team_show_style_16_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_16($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                    ...
                                    <div class="member-photo">
                                        ...
                                        <div class="team-content">                                                   
                                            ...
                                            <div class="member-icons ' . $styledata[157] . '">
                                                ' . oxi_team_show_style_16_social($data[9], $data[7], $styledata[79]) . '
                                                ' . oxi_team_show_style_16_social($data[13], $data[11], $styledata[79]) . '
                                                ' . oxi_team_show_style_16_social($data[17], $data[15], $styledata[79]) . '
                                                ' . oxi_team_show_style_16_social($data[21], $data[19], $styledata[79]) . '
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <style>
            ...
            .oxi-team-show-<?php echo $styleid; ?> .team-content:before{
                content: "";
                width: 80%;
                height: 80%;
                background-color: <?php echo $styledata[99]; ?>;
            ...
            .oxi-team-show-<?php echo $styleid; ?>:hover .team-content:before{
                top: 0;
            ...
            .oxi-team-show-<?php echo $styleid; ?> .team-content:after{
                content: "";
                width: 80%;
                height: 80%;
                background-color:  <?php echo $styledata[99]; ?>;
            ...
            .oxi-team-show-<?php echo $styleid; ?>:hover .team-content:before,
            .oxi-team-show-<?php echo $styleid; ?>:hover .team-content:after {
                top: 0;
                -webkit-transform: rotate(0deg);
                -moz-transform: rotate(0deg);
                -ms-transform: rotate(0deg);
            ...
            .oxi-team-show-<?php echo $styleid; ?>:hover .member-icons{
                visibility: visible;
                height: auto;                                 
                padding-bottom: <?php echo $styledata[149]; ?>px;
                padding-top: <?php echo $styledata[151]; ?>px; 
                -webkit-opacity: 1;
                -moz-opacity: 1; 
                -ms-opacity: 1; 
                -o-opacity: 1; 
