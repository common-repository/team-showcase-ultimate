...
function oxi_team_show_style_11_social($url, $social, $linkopen) {
    if ($linkopen == '_blank') {
...
function oxi_team_show_shortcode_function_style_11($styleid, $userdata, $styledata, $listdata, $categorydata, $socialdata) {
    ...
    <div class="oxi-team-show-wrapper">
                                        ...
                                        <div class="oxi-team-show">
                                            <div class="member-photo ' . $styledata[77] . '">
                                                ...
                                                <div class="team-content">                                                   
                                                   ...
                                                   ' . oxi_team_show_style_11_social($data[9], $data[7], $styledata[79]) . '
                                                   ' . oxi_team_show_style_11_social($data[13], $data[11], $styledata[79]) . '
                                                   ' . oxi_team_show_style_11_social($data[17], $data[15], $styledata[79]) . '
                                                   ' . oxi_team_show_style_11_social($data[21], $data[19], $styledata[79]) . '
                                                </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <style>  
            ...
            .oxi-team-show-<?php echo $styleid; ?> .oxi-team-show{
                ...
                width: 100%;
                float: left;
                padding: 0  calc(<?php echo $styledata[161]; ?>px + 3px);
            }
