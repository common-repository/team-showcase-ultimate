...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' name-background-color |' . sanitize_text_field($_POST['name-background-color']) . '|'
                . ' position-background-color |' . sanitize_text_field($_POST['position-background-color']) . '|'
                . ' team-box-border-left-color |' . sanitize_text_field($_POST['team-box-border-left-color']) . '|'
                . ' team-box-border-right-color |' . sanitize_text_field($_POST['team-box-border-right-color']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-6">
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number('team-animation-duration', $styledata[87], '0.1', 'Animation Duration', 'Select the duration of the Animation showing. Based on Seconds');
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_color('team-box-bg-color', $styledata[99], 'rgba', 'Hover Background Color', 'Select hover color for team background, Base color RGBA');
                                                echo oxi_team_show_admin_number('name-general-padding-top-bottom', $styledata[101], '', 'Padding bottom', 'Confirm Your Content Padding Bottom with distance');
                                                echo oxi_team_show_admin_color('team-box-border-left-color', $styledata[163], 'rgba', 'Border Left Color', 'Customize your Border Left Color');
                                                echo oxi_team_show_admin_color('team-box-border-right-color', $styledata[165], 'rgba', 'Border Right Color', 'Customize your Border Right Color');
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                echo oxi_team_show_admin_color('name-background-color', $styledata[159], 'rgba', 'Background Color', 'Customize Your Name background color');
                                                ...
                                                echo oxi_team_show_admin_number_double('name-margin-top', $styledata[115], 'name-margin-bottom', $styledata[117], 'Padding', 'Create some space between Member\'s name and Member\'s role');
                                                ?>
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_color('position-background-color', $styledata[161], 'rgba', 'Background Color', 'Customize Your Background Color, base on RGBA');
