...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'teamstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' team-border-width-color |' . sanitize_text_field($_POST['team-border-width-color']) . '|'
                . ' team-box-bg-color-padding-top |' . sanitize_text_field($_POST['team-box-bg-color-padding-top']) . '|'
                . ' team-box-bg-color-padding-left |' . sanitize_text_field($_POST['team-box-bg-color-padding-left']) . '|'
                . ' team-box-bg-color-border |' . sanitize_text_field($_POST['team-box-bg-color-border']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_color('team-border-width-color', $styledata[159], 'rgba', 'Background  Color', 'Confirm Hover Background & Border Color, Base color RGBA');
                                                ...
                                                echo oxi_team_show_admin_number_double('team-box-bg-color-padding-top', $styledata[161], 'team-box-bg-color-padding-left', $styledata[163], 'Padding', 'Set the padding for top bottom and left right side of the category body');
                                                echo oxi_team_show_admin_number('team-box-bg-color-border', $styledata[165], '', 'Border Size', 'Confirm Your Border Size With width');
                                                ?> 
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number_double('icon-padding-top-bottom', $styledata[149], 'icon-padding-left-right', $styledata[151], 'Padding Top & Bottom', 'Make the space at the top-bottom portion of the Icon');
                                                ?> 
                                            </div>
                                        </div>
                                        <?php
