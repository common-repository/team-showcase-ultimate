...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'teamstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' content-top-border-radius |' . sanitize_text_field($_POST['content-top-border-radius']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number('content-top-border-radius', $styledata[159], '$step', 'Border Radius', 'Confirm Your Border radius')
                                                ?>  
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number('position-margin-bottom', $styledata[131], '', 'Margin Bottom', 'Make the space at the bottom portion of the member role');
                                                ?>                                              
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="team-custom-css" name="team-custom-css"><?php echo $styledata[161]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
