...
if (!empty($_POST['submit']) && $_POST['submit'] == 'submit') {
    if (!wp_verify_nonce($nonce, 'oxiteamshownewdata')) {
        ...
        $data = ' oxi-team-name {#}|{#}' . sanitize_text_field($_POST['oxi-team-name']) . '{#}|{#}'
                ...
                . 'oxi-team-description {#}|{#}' . sanitize_text_field($_POST['oxi-team-description']) . '{#}|{#}';
...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        die('You do not have sufficient permissions to access this page.');
    } else {
        $data = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' icon-div-background-color |' . sanitize_text_field($_POST['icon-div-background-color']) . '|'
                ...
                . ' icon-padding-left-right |' . sanitize_text_field($_POST['icon-padding-left-right']) . '|'
                ...
                . ' name-hover-color |' . sanitize_text_field($_POST['name-hover-color']) . '|'
                . ' position-hover-color |' . sanitize_text_field($_POST['position-hover-color']) . '|'
                . ' ||'
                . ' team-box-content-color |' . sanitize_text_field($_POST['team-box-content-color']) . '|'
                . ' team-icon-padding-left-right |' . sanitize_text_field($_POST['team-icon-padding-left-right']) . '|'
                . ' des-font-size |' . sanitize_text_field($_POST['des-font-size']) . '|'
                . ' des-color |' . sanitize_text_field($_POST['des-color']) . '|'
                . ' des-font-family |' . sanitize_text_field($_POST['des-font-family']) . '|'
                . ' des-font-weight |' . sanitize_text_field($_POST['des-font-weight']) . '|'
                . ' des-font-style |' . sanitize_text_field($_POST['des-font-style']) . '|'
                . ' des-margin-bottom |' . sanitize_text_field($_POST['des-margin-bottom']) . '|'
                    ...
                    <div class="oxilab-admin-style-panel-left-settings-row">
                        <form method="post">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_color('team-box-bg-color', $styledata[99], 'rgba', 'Image Hover Color', 'Select Hover color for team background, Base color RGBA');
                                                echo oxi_team_show_admin_color('team-box-content-color', $styledata[165], 'rgba', 'Content Background Color', 'Select color for Content Background Color, based on RGBA');
                                                echo oxi_team_show_admin_number('team-icon-padding-left-right', $styledata[167], '', 'Padding', 'Confirm Your Content Padding with distance');
                                                ?>          
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                echo oxi_team_show_admin_color('name-hover-color', $styledata[159], 'rgba', 'Hover Color', 'Customize Your Name hover color');
                                                ...
                                                echo oxi_team_show_admin_number('name-margin-top', $styledata[115], '', 'Padding Top', 'Confirm Your Padding top distance from Title');
                                                ?>                                                
                                            </div>
                                        </div>
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_color('position-hover-color', $styledata[161], 'rgba', 'Hover Color', 'Customize Your hover position Color');
                                                ...
                                                echo oxi_team_show_admin_number_double('position-margin-top', $styledata[129], 'position-margin-bottom', $styledata[131], 'Padding', 'Make the space at the top-bottom portion of the member role');
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number('des-font-size', $styledata[169], '1', 'Font Size', 'Customize Your Description Font size');
                                                echo oxi_team_show_admin_color('des-color', $styledata[171], '', 'Color', 'Customize Your Description Color');
                                                echo oxi_team_show_admin_font_family('des-font-family', $styledata[173], 'Font Family', 'Choose Your Description Preferred font, Based on Google Font');
                                                echo oxi_team_show_admin_font_weight('des-font-weight', $styledata[175], 'Font Weight', 'Customize the Font weight of the Member role text with default size or style');
                                                echo oxi_team_show_admin_font_style('des-font-style', $styledata[177], 'Font Style', 'Customize the Member description text font style. Select Normal when no need any style');
                                                echo oxi_team_show_admin_number('des-margin-bottom', $styledata[179], '', 'Padding Bottom', 'Confirm Your Padding bottom distance from content box');
                                                ?>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="icon-style" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Customize Your icon Style">Icon Style</label>
                                                    <div class="col-sm-6">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_color('icon-div-background-color', $styledata[137], 'rgba', 'Background Color', 'Customize the background color of icon area. Base color RGB');
                                                echo oxi_team_show_admin_number_double('icon-padding-top-bottom', $styledata[149], 'icon-padding-left-right', $styledata[151], 'Padding Top & Bottom', 'Confirm Your padding top & bottom from Icon');
                                                ?>                                              
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="team-custom-css" name="team-custom-css"><?php echo $styledata[182]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
                            ...
                            <div class="oxilab-setting-save">
                                ...
                                <?php wp_nonce_field("flipboxstylecss") ?>
                            </div>
                        </form>                        
                    </div>
                </div>
                    ...
                    <form method="POST">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label for="oxi-team-description">Information</label>
                                    <textarea type="text"class="form-control" id="oxi-team-description" name="oxi-team-description"> <?php echo oxilab_team_admin_html_special_charecter($listexdata[25]); ?></textarea>
                                    <small class="form-text text-muted">Add Information.</small>
                                </div>
                                <div class="form-group">
...
foreach ($icondata as $value) {
    echo '.oxi-team-show-' . $styleid . ' .oxi-member-icons-background-border .' . $value['class'] . ':hover{
            color: ' . $value['color'] . ';
            background-color: ' . $value['bgcolor'] . ';
...
foreach ($icondata as $value) {
    echo '.oxi-team-show-' . $styleid . ' .oxi-member-icons-border .' . $value['class'] . ':hover{
            color: ' . $value['bgcolor'] . ';
            border: ' . $value['bgcolor'] . ';
            }';
}
?>
</style>