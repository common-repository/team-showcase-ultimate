...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'teamstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' oxi-custom-css |' . sanitize_text_field($_POST['oxi-custom-css']) . '|';
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_social_icon_selector($icondata, $styleid, $styledata[157], $styledata[135], 'transparent', $styledata[143], $styledata[145]);
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number('icon-position', $styledata[159], '$step', 'Icon Position', 'Confirm Your Icon Position with Bottom Distance');
                                                echo oxi_team_show_admin_number('icon-padding-left-right', $styledata[151], '', 'Padding Left-Right', 'Confirm Your Padding Left-Right');
                                                ?>                                                                                            
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label for="oxi-custom-css">Add Your Custom CSS Code Here</label>
                                                <textarea class="form-control" rows="4" id="oxi-custom-css" name="oxi-custom-css"><?php echo $styledata[161]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
