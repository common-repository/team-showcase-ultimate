...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' team-box-bg-color-padding-top-width |' . sanitize_text_field($_POST['team-box-bg-color-padding-top-width']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number('team-box-bg-color-padding-top-width', $styledata[161], '', 'Body Top', 'Set the Padding Top width of the Content body');
                                                echo oxi_team_show_admin_color('team-box-bg-color-padding-top', $styledata[159], '', 'Padding Top Color', 'Customize top content padding color');
