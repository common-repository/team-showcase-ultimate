...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' team-box-margin |' . sanitize_text_field($_POST['team-box-margin']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number('team-box-margin', $styledata[181], '', 'Margin', 'Confirm Your Content margin with distance');
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_color('name-color', $styledata[107], '', 'Color', 'Customize the color of Name text');
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number_double('position-margin-top', $styledata[129], 'position-margin-bottom', $styledata[131], 'Padding Top & Bottom', 'Make the space at the top-bottom portion of the member role');
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number('icon-padding-top-bottom', $styledata[149], '', 'Padding Bottom', 'Confirm Your padding bottom from Icon');
                                                ?>
                                            </div>
                                        </div>
                                        <?php
