...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'teamstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' Scroll-width |' . sanitize_text_field($_POST['Scroll-width']) . '|'
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="team-border" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Confirm Your Tem Distance From Another Team Step 5" >Border Size & Type</label>
                                                    <div class="col-sm-3">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number('Scroll-width', $styledata[161], '', 'Width', 'Confirm Your Box Widthwith Distance.')
                                                ?>
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="team-custom-css" name="team-custom-css"><?php echo $styledata[167]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
