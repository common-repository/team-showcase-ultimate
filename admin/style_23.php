...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' ||'
                . ' position-border-bottom-color|' . sanitize_text_field($_POST['position-border-bottom-color']) . '|'
                ...
                . ' team-icon-padding-top|' . sanitize_text_field($_POST['team-icon-padding-top']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number_double('team-icon-padding-top', $styledata[165], 'team-icon-padding-left-right', $styledata[167],'Padding', 'Confirm Your Content Padding left right and top with distance');
                                                ?> 
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_color('position-border-bottom-color', $styledata[117], '', 'Border Bottom Color', 'Confirm Your Border Bottom Color');
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                echo oxi_team_show_admin_number('des-margin-bottom', $styledata[179], '', 'Padding Top', 'Confirm Your Padding Top distance');
                                                ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_color('icon-div-background-color', $styledata[163], 'rgba', 'Background Color', 'Customize the background color of icon area. Base color RGBA');
                                                ?>
                                            </div>
                                        </div>
                                        <?php
