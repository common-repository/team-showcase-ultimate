...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'oxiteamstylecss')) {
        die('You do not have sufficient permissions to access this page.');
    } else {
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' name-font-family |' . sanitize_text_field($_POST['name-font-family']) . '|'
                    ...
                    <div class="oxilab-admin-style-panel-left-settings-row">
                        <form method="post"  id="oxi-team-form-submit">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_font_family('name-font-family', $styledata[109], 'Font Family', 'Select the name font based on google font-family');
                                                echo oxi_team_show_admin_font_weight('name-font-weight', $styledata[111], 'Font Weight', 'Customize the font weight of the name text with dafault size or style');
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_number_double('icon-padding-top-bottom', $styledata[149], 'icon-padding-left-right', $styledata[151], 'Padding', 'Customize the background color of icon area. Base color RGB');
                                                ?>                                                  
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="team-custom-css" name="team-custom-css"><?php echo $styledata[159]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
                            ...
                            <div class="oxilab-setting-save">
                                ...
                                <?php wp_nonce_field("oxiteamstylecss") ?>
                            </div>
                        </form>
                    </div>
                </div>
