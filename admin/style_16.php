                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number_double('icon-padding-top-bottom', $styledata[149], 'icon-padding-left-right', $styledata[151], 'Padding Top', 'Generate the top padding from icon body');
                                                ?>
                                            </div>
                                        </div>
                                        <?php
