...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' Scroll-padding |' . sanitize_text_field($_POST['Scroll-padding']) . '|'
                . ' team-border |' . sanitize_text_field($_POST['team-border']) . '|'
                . ' team-border-type |' . sanitize_text_field($_POST['team-border-type']) . '|'
                . ' flipbox-custom-css |' . sanitize_text_field($_POST['flipbox-custom-css']) . '|';
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="team-border" class="col-sm-6 control-label" data-toggle="tooltip" data-placement="top" title="Confirm Your Team Distance From Another Team Step 5" >Border Size & Type</label>
                                                    <div class="col-sm-3">
                                                        <input type="number" class="form-control" min="0" step="1" max="150" id="team-border" name="team-border" value="<?php echo $styledata[163]; ?>">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <select class="form-control" id="team-border-type" name="team-border-type">
                                                            <option <?php
                                                            if ($styledata[165] == 'solid') {
                                                                echo 'selected';
                                                            }
                                                            ?> value="solid">Solid</option>
                                                            <option <?php
                                                            if ($styledata[165] == 'Dashed') {
                                                                echo 'selected';
                                                            }
                                                            ?> value="dashed">Dashed</option>
                                                            <option <?php
                                                            if ($styledata[165] == 'double') {
                                                                echo 'selected';
                                                            }
                                                            ?> value="double">Double</option>
                                                            <option <?php
                                                            if ($styledata[165] == 'groove') {
                                                                echo 'selected';
                                                            }
                                                            ?> value="groove">Groove</option>
                                                            <option <?php
                                                            if ($styledata[165] == 'inset') {
                                                                echo 'selected';
                                                            }
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_color('team-border-color', $styledata[159], 'rgb', 'Border Color', 'Confirm Your Team Border Color')
                                                ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-4">
                                        <div class="oxilab-tabs-content-div-50">
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number('Scroll-padding', $styledata[161], '', 'Padding', 'Generate the space at the icon body.')
                                                ?>
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                <label for="flipbox-custom-css">Add Your Custom CSS Code Here</label>
                                                <textarea class="form-control" rows="4" id="flipbox-custom-css" name="flipbox-custom-css"><?php echo $styledata[167]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
