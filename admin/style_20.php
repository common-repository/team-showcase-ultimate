...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' team-box-content-hover-color |' . sanitize_text_field($_POST['team-box-content-hover-color']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_color('team-box-content-color', $styledata[165], '', 'Content Background Color', 'Select color for Content Background Color.');
                                                echo oxi_team_show_admin_color('team-box-content-hover-color', $styledata[181], 'rgba', 'Hover Content Color', 'Customize your Content hover Background Color');
                                                echo oxi_team_show_admin_number('team-icon-padding-left-right', $styledata[167], '', 'Padding', 'Confirm Your Content Padding Bottom with distance');
                                                ?> 
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                                ...
                                                echo oxi_team_show_admin_color('name-hover-color', $styledata[159], '', 'Hover Color', 'Customize Your Name hover color');
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                echo oxi_team_show_admin_color('position-hover-color', $styledata[161], '', 'Hover Color', 'Customize Your hover position Color');
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="icon-style" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Customize Your Icon Font Style">Icon Style</label>
                                                    <div class="col-sm-6">
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="team-custom-css" name="team-custom-css"><?php echo $styledata[183]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
