                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-5">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_color('team-box-bg-color', $styledata[99], 'rgba', 'Hover Background Color', 'Select color for team hover background, Base color RGBA');
                                                echo oxi_team_show_admin_color('content-background-color', $styledata[165], 'rgba', 'Content Background Color', 'Select color for Content Background Color, based on RGBA');
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="team-custom-css" name="team-custom-css"><?php echo $styledata[171]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
