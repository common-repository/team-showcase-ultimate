...
if (!empty($_POST['data-submit']) && $_POST['data-submit'] == 'Save') {
    if (!wp_verify_nonce($nonce, 'flipboxstylecss')) {
        ...
        $css = '  team-category|' . sanitize_text_field($_POST['team-category']) . '|'
                ...
                . ' icon-position |' . sanitize_text_field($_POST['icon-position']) . '|'
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-6">
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number('team-width', $styledata[71], '1', 'Image Width', 'Edit your team image width, Based on pixel');
                                                echo oxi_team_show_admin_number('team-height', $styledata[73], '1', 'Image Height', 'Edit your team image height, Based on pixel');
                                                ?>  
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                                                <div class="head-oxi">
                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <div class="form-group row form-group-sm">
                                                    <label for="icon-style" class="col-sm-6 col-form-label" data-toggle="tooltip" data-placement="top" title="Customize icon showing style">Icon Style</label>
                                                    <div class="col-sm-6">
                                                        <select class="form-control" id="icon-style" name="icon-style">
                                                            <option value="oxi-member-icons-style-1" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-1') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 1</option>
                                                            <option value="oxi-member-icons-style-2" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-2') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 2</option>
                                                            <option value="oxi-member-icons-style-3" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-3') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 3</option>
                                                            <option value="oxi-member-icons-style-4" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-4') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 4</option>
                                                            <option value="oxi-member-icons-style-5" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-5') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 5</option>
                                                            <option value="oxi-member-icons-style-6" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-6') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 6</option>
                                                            <option value="oxi-member-icons-style-7" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-7') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 7</option>
                                                            <option value="oxi-member-icons-style-8" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-8') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 8</option>
                                                            <option value="oxi-member-icons-style-9" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-9') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 9</option>
                                                            <option value="oxi-member-icons-style-10" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-10') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 10</option>
                                                            <option value="oxi-member-icons-style-11" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-11') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 11</option>
                                                            <option value="oxi-member-icons-style-12" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-12') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 12</option>
                                                            <option value="oxi-member-icons-style-13" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-13') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 13</option>
                                                            <option value="oxi-member-icons-style-14" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-14') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 14</option>
                                                            <option value="oxi-member-icons-style-15" <?php
                                                            if ($styledata[153] == 'oxi-member-icons-style-15') {
                                                                echo 'selected';
                                                            }
                                                            ?> >Style 15</option>
                                                ...
                                                <?php
                                                echo oxi_team_social_icon_selector($icondata, $styleid, $styledata[153], $styledata[135], $styledata[137], $styledata[143], $styledata[145]);
                                                ...
                                                echo oxi_team_show_admin_color('icon-div-background-color', $styledata[137], 'rgba', 'Background Color', 'Customize the background color of icon area. Base color RGBA');
                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                <?php
                                                echo oxi_team_show_admin_number('icon-position', $styledata[155], '1', 'Icon Position', 'Confirm Your Icon Position with Bottom Distance');
                                                echo oxi_team_show_admin_number_double('icon-padding-top-bottom', $styledata[149], 'icon-padding-left-right', $styledata[151], 'Padding', 'Make the space at the top-bottom portion of the Icon');
                                                ?>
                                            </div>
                                        </div>
                                        <?php
                                    ...
                                    <div class="oxilab-tabs-content-tabs" id="oxilab-tabs-id-2">
                                        <div class="col-xs-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="4" id="team-custom-css" name="team-custom-css"><?php echo $styledata[157]; ?></textarea>
                                            </div>
                                        </div>                                        
                                    </div>
